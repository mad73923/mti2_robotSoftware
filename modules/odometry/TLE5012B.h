...
#define TLE5012B_CS_EnableGPIOClock_L() LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_GPIOC)
#define TLE5012B_CS_PORT_L	GPIOC
#define TLE5012B_CS_PIN_L	LL_GPIO_PIN_2
#define TLE5012B_CS_EnableGPIOClock_R() LL_AHB2_GRP1_EnableClock(LL_AHB2_GRP1_PERIPH_GPIOC)
#define TLE5012B_CS_PORT_R	GPIOC
#define TLE5012B_CS_PIN_R	LL_GPIO_PIN_4

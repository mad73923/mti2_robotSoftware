...
void CS_init(void){
	...
	TLE5012B_CS_EnableGPIOClock_R();
	LL_GPIO_SetPinMode(TLE5012B_CS_PORT_R, TLE5012B_CS_PIN_R, LL_GPIO_MODE_OUTPUT);
	LL_GPIO_SetPinSpeed(TLE5012B_CS_PORT_R, TLE5012B_CS_PIN_R, LL_GPIO_SPEED_FREQ_VERY_HIGH);
	LL_GPIO_SetOutputPin(TLE5012B_CS_PORT_R, TLE5012B_CS_PIN_R);
}
...
void CS_activateRight(void){
	LL_GPIO_ResetOutputPin(TLE5012B_CS_PORT_R, TLE5012B_CS_PIN_R);
}
